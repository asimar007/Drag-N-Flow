    ...
    >
      ...
      {mouseIsOver && (
        <button
          ...
          className="stroke-white absolute right-4 top-1/2 -translate-y-1/2 bg-columnBackgroundColor p-2 hover:bg-columnBackgroundColor rounded px-1 py-2 opacity-60 hover:opacity-100"
        >
          <TrashIcon />
        </button>
      )}
